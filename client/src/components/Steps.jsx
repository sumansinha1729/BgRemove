...
const Steps = () => {
  return (
    <div className='mx-4 lg:mx-44 py-20 xl:py-40'>
      ...
      '>Steps to remove background images in seconds</h1>

      <div className='flex items-start flex-wrap gap-4 mt-16 xl:mt-24 justify-center'>
        <div className='flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all
        duration-500'>
        ...
        duration-500'>
            ...
            <div>
                <p className='text-xl font-medium'>Download icon</p>
                <p className='text-sm text-neutral-500 mt-1'>This is a demo text, will replace it later.<br/>This is a demo</p>
            </div>
        </div>
      </div>
